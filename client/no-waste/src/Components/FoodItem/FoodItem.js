...
function FoodItem({ item, user, setUser}) {
  ...
  return (
    ...
    <div className='contain'>
      ...
      <div id="imgContainer" className=' tc center ma1 pa2 br2 bg-white grow'><img className="tc imgFit center" src={item.photo} ></img></div>
      <div onClick={onDelete} className='itemShare tc center ma1 pa2 br2 bg-black white grow'><h4></h4>delete</div>
    </div>
