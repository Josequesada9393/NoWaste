...
function Icon() {
  ...
  <div className='ma4 mt0'>
      <Tilt reset={false} gyroscope={true} tiltMaxAngleX={25} tiltMaxAngleY={25} glareColor={'#afdc'}>
        <div className="Tilt br4 grow shadow-2" options={{max: 55}} style={{ marginTop: "10%", marginLeft: "auto", height: '120px', width: '120px', backgroundColor: 'transparent', border: 'none', opacity: 0.7}}>
